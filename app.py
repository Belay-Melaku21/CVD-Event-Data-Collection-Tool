...
with st.form("cvd_research_form", clear_on_submit=True):
    ...
    st.markdown("### Section 3: Socio-Demographic Characteristics")
    ...
    with col7:
        ...
        st.write(f"**5.2. HTN Stage (Auto):** {htn_stage}")
